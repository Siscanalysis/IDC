...
These examples are **not** part of the four §7 case studies shown in the
paper. They belong to the broader catalog of ~30 benchmark problems that
§7.1 of the manuscript refers to as
...
were headline examples in an earlier manuscript draft; the final §7 was
...
|---------------------|-----------|-------------------|----------------|
| `concrete_uci_so/`  | Real SO   | Linear mass-balance | Single-objective view of the UCI Concrete dataset used by §7.5; part of the broader SO sweep (`benchmarks/`, problem `concrete_uci`). |
